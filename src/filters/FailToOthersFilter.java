...
public class FailToOthersFilter implements CdrFilter{
	@Override
	public int parse(String[] dataArray, List<String> headerColumns) {
		if (dataArray[headerColumns.indexOf(ORIG_DEVICE_NAME.getCode())].startsWith("SEP")
				...
				&& !dataArray[headerColumns.indexOf(FINAL_CALLED_PARTY_NUMBER.getCode())].matches("^(06|07)\\d{8}$")
